...
const updateProfile=(userId,data)=>{
    ...
    <div>
      ...
      <div style={{"display":"flex","justifyContent":"space-around","marginTop":"2rem"}}>
        ...
        <p className="text-red-400 hover:text-red-500"> UserName</p>
            ...
            <div style={{"display":"flex","justifyContent":"flex-start","margin":"3rem 7rem","gap":"10rem"}}>
            <section>
       <div>
        <div>
  ...
  <div className="relative z-0 w-full mb-5 group">
      <input type="password" name="repeat_password" id="confirmed_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required 
  ...
  <button type="submit" className="focus:outline-none text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Confirm Changes</button>
  </div>
